    ...
    def decode(self, sentence_tokens: List[Token]) -> LabeledSentence:
        ...
        for tok in sentence_tokens:
            if tok.word in self.words_to_tag_counters:
                # [0] selects the top most common (tag, count) pair, the next [0] picks out the tag itself e.g. O, B-PER
                # print(self.words_to_tag_counters[tok.word].most_common(1))
